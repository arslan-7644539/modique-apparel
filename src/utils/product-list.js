export const productData = [
  {
    ...
    images: [
      "/article1/art-1-1.jpg",
      "/article1/art-1-2.jpg",
      "/article1/art-1-3.jpg",
      "/article1/art-1-4.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    ...
    fabric: " lawn shirt with inner and trouser",
    images: [
      "/article2/art-2-1.jpg",
      "/article2/art-2-2.jpg",
      "/article2/art-2-3.jpg",
      "/article2/art-2-4.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
  ...
  },
  {
    ...
    fabric: " lawn shirt with inner and trouser",
    images: [
      "/article8/art-8-1.jpg",
      "/article8/art-8-2.jpg",
      "/article8/art-8-3.jpg",
      "/article8/art-8-4.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    ...
    fabric: " lawn shirt with inner and trouser",
    images: [
      "/article9/art-9-2.jpg",
      "/article9/art-9-1.jpg",
      "/article9/art-9-3.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    ...
    originalPrice: {
      "2_piece": "2_piece: PKR 6,300",
      "3_piece": "3_piece: PKR  7,100",
    },
    ...
    fabric: " lawn shirt with inner and trouser",
    images: [
      "/article10/art-10-1.jpg",
      "/article10/art-10-2.jpg",
      "/article10/art-10-3.jpg",
      "/article10/art-10-4.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    ...
    fabric: " lawn shirt with inner and trouser",
    images: [
      "/article11/art-11-1.jpg",
      "/article11/art-11-2.jpg",
      "/article11/art-11-3.jpg",
      "/article11/art-11-4.jpg",
      "/article11/art-11-5.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    id: 12,
    title: "Amber Elegance - 2 Piece Silk Ensemble",
    price: "PKR  5,100 .",
    originalPrice: "PKR  6,100 ",

    description:
      "Amber Elegance is a premium 2-piece silk set featuring intricate traditional motifs in rich orange and black on a soft beige canvas. Accented with statement tassels and tailored for comfort, it’s ideal for festive and semi-formal occasions.Paired with plain cream-colored straight pants, the ensemble balances ornate design with simplicity.",
    fabric: " lawn shirt with inner and trouser",
    images: [
      "/article12/art-12-1.jpg",
      "/article12/art-12-2.jpg",
      "/article12/art-12-3.jpg",
      "/article12/art-12-4.jpg",
      "/article12/art-12-5.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
  },
];
